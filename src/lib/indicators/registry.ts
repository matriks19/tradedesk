...
export const BUILTIN_LIST: IndicatorMeta[] = [
  ...
  { id: "ifvgJurikStoch", label: "IFVG×Jurik Stoch", category: "momentum", pane: "sub", acceptsSeries: false, primarySeriesKey: "k", description: "IFVG uygulanmış Jurik Stochastic (jurikStoch k/d, JMA-smoothed %K; periods 28/6/20). Retest × K/D cross (soft mid K<50/>50) veya OS/OB (20/80) yükseliş/düşüş. Bakeoff vs SMI/RSI.", inputs: [num("kLen", "%K", 28), num("dLen", "%D", 6), num("jmaLen", "JMA Length", 20), num("phase", "Phase", 50, -100, 100, 1), num("power", "Power", 2, 0.1, 10, 0.1), num("os", "OS", 20, 1, 50, 1), num("ob", "OB", 80, 50, 99, 1), num("softMid", "Soft Mid", 1, 0, 1, 1), num("swingStrength", "Swing", 2), num("maxInvLookforward", "İnv. Lookforward", 40), num("maxRetestLookforward", "Retest Lookforward", 30)] },
